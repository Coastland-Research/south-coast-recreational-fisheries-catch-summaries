...
#| warning: false
#| 
data<-read_excel("data/2025_data/catch and release data august 2025 version.xlsx",sheet="chinook catch and release")

effort<-read_excel("data/2025_data/catch and release data august 2025 version.xlsx",sheet="effort by target species")
```
...
new.effort.data<-fread("data/common/South_Coast_Recreational_effort_2012-2023.csv")
...
```{r 2025 data read and prep}
#| echo: false
#| message: false
#| warning: false

# chinook
d25<-read_excel("data/2025_data/catch and release data august 2025 version.xlsx",sheet="2025 creel survey chinook")

d25.long<-d25%>%mutate(encounters=kept+released) %>%
pivot_longer(c(5:7),names_to="disposition",values_to ="estimate") %>%
  mutate(area2=factor(area))

# coho
d25_co <-read_excel("data/2025_data/catch and release data august 2025 version.xlsx",sheet="2025 creel survey coho")

d25_co.long<-d25_co%>%mutate(encounters=kept+released) %>%
pivot_longer(c(5:7),names_to="disposition",values_to="estimate") %>%
  mutate(area2=factor(area))

```

```{r 2025 per SE data read}
#| echo: false
#| message: false
#| warning: false

# chinook
perse25<-read_excel("data/2025_data/catch and release data august 2025 version.xlsx",sheet="percent SE 2025 chinook")%>% mutate(Area=factor(area))

# coho
perse25co<-read_excel("data/2025_data/catch and release data august 2025 version.xlsx",sheet="percent SE 2025 coho")%>% mutate(Area=factor(area))
...
##### 2024 data #####
d22<-read_excel("data/2024_archive/catch and release data sept 2024 version.xlsx",sheet="2024 sept creel survey totals")
...
#####
perse<-read_excel("data/2024_archive/catch and release data sept 2024 version.xlsx",sheet="percent SE 2024 creel summary")%>%mutate(area2=factor(area))
...
```{r 2025 creel survey summary}
#| label: fig-2025-creel-survey-summary
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Top: Total encounters of Chinook by area and area grouping for 2025 year to date and the 5-yr average. Bottom: Percentage change in total encounters (2025 YTD versus 5-yr average)."
...
cnplot_25 <- ggplot(d25_25, aes(x = region, y = estimate, fill = Area)) +
  geom_col() +
  theme_bw() +
  facet_grid(disposition~month) +
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5, hjust=0.5)) +
  ggtitle("2025 Chinook effort and catch estimates by month and region") +
  labs(x = "Region", y = "Estimate") +
    scale_fill_viridis_d()


# for coho
d25_25_co <- d25_co.long %>%
  filter(year == "2025") %>%
  mutate(month = factor(month, levels = c("June", "July", "August")),
         Area = factor(area))

coplot_25 <- ggplot(d25_25_co, aes(x = region, y = estimate, fill = Area)) +
  geom_col() +
  theme_bw() +
  facet_grid(disposition~month) +
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5, hjust=0.5)) +
  ggtitle("2025 Coho effort and catch estimates by month and region") +
  labs(x = "Region", y = "Estimate") +
  scale_fill_viridis_d()

# d25.effort<-d25.long%>%filter(disposition=="effort")
# 
# e25.1<-ggplot(d25.effort,aes(x=area2,y=estimate,fill=year))+
...
# 
# d25.effort.pchange<-d25.effort%>%pivot_wider(names_from="year",values_from="estimate")%>%
#   mutate(pchange=(`2025`-`5-yr`)/`5-yr`*100)%>%
#   select(area2,region,disposition,pchange)
# 
# e25.2<-ggplot(d25.effort.pchange,aes(x=area2,y=pchange))+
#   geom_col(position="dodge")+
#   #scale_fill_brewer(palette="Set1")+
#   theme_bw()+
#   geom_hline(yintercept=0)+
#   facet_grid(.~region,space="free",scale="free",switch="x",labeller = labeller(region = label_wrap_gen(10)))+
#   labs(x="Area",y="Percent Change in Effort (2025 versus 5-yr average)")

```

```{r 2025 creel survey summary output cn}
#| label: fig-2025-creel-survey-summary-output-effort
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Total effort, kept catch, and released catch by area and month for 2025 year to date for Chinook."

cnplot_25

```

```{r 2025 creel survey summary output co}
#| label: fig-2025-creel-survey-summary-effort-co
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Total effort, kept catch, and released catch by area and month for 2025 year to date for Coho."

coplot_25

```

```{r 2025 creel survey summary kept}
# #| label: fig-2025-creel-summary-kept
# #| echo: false
# #| message: false
# #| warning: false
# #| fig-height: 9
...
# #| fig-cap: ")."
#  
# d25.kept<-d25.long%>%filter(disposition=="kept")
# 
# c25.1<-ggplot(d25.kept,aes(x=area2,y=estimate,fill=year))+
#   geom_col(position="dodge")+
#   scale_fill_brewer(palette="Set1")+
#   theme_bw()+
#   facet_grid(.~region,space="free",scale="free",switch="x",labeller = labeller(region = label_wrap_gen(10)))+
...
#   theme(legend.position="bottom")
# 
# d25.kept.pchange<-d25.kept%>%pivot_wider(names_from="year",values_from="estimate")%>%
#   mutate(pchange=(`2025`-`5-yr`)/`5-yr`*100)%>%
#   select(area2,region,disposition,pchange)
# 
# c25.2<-ggplot(d25.kept.pchange,aes(x=area2,y=pchange))+
#   geom_col(position="dodge")+
#   #scale_fill_brewer(palette="Set1")+
#   theme_bw()+
#   geom_hline(yintercept=0)+
#   facet_grid(.~region,space="free",scale="free",switch="x",labeller = labeller(region = label_wrap_gen(10)))+
#   labs(x="Area",y="Percent Change in Kept Catch\n(2025 versus 5-yr average)")
```

```{r 2025 creel survey summary output kept}
# #| label: fig-2025-creel-summary-output-kept
# #| echo: false
# #| message: false
# #| warning: false
# #| fig-height: 9
# #| fig-width: 8
# #| fig-cap: "Top: Total kept catch of Chinook by area and area grouping for 2025 year to date and the 5-yr average. Bottom: Percentage change in total kept catch (2025 YTD versus 5-yr average)."
# 
# c25.1/c25.2

```

```{r 2025 creel survey summary release}
# #| label: fig-2025-creel-summary-release
# #| echo: false
# #| message: false
# #| warning: false
# #| fig-height: 9
...
# #| fig-cap: ")."
# 
# d25.rel<-d25.long%>%filter(disposition=="released")
# 
# r25.1<-ggplot(d25.rel,aes(x=area2,y=estimate,fill=year))+
#   geom_col(position="dodge")+
#   scale_fill_brewer(palette="Set1")+
#   theme_bw()+
#   facet_grid(.~region,space="free",scale="free",switch="x",labeller = labeller(region = label_wrap_gen(10)))+
...
#   theme(legend.position="bottom")
# 
# d25.rel.pchange<-d25.rel%>%pivot_wider(names_from="year",values_from="estimate")%>%
#   mutate(pchange=(`2025`-`5-yr`)/`5-yr`*100)%>%
#   select(area2,region,disposition,pchange)
# 
# r25.2<-ggplot(d25.rel.pchange,aes(x=area2,y=pchange))+
#   geom_col(position="dodge")+
#   #scale_fill_brewer(palette="Set1")+
#   theme_bw()+
#   geom_hline(yintercept=0)+
...
```{r 2025 creel survey summary output released}
##| label: fig-2025-creel-summary-output-released
##| echo: false
##| message: false
##| warning: false
##| fig-height: 9
##| fig-width: 8
##| fig-cap: "Top: Total released catch of Chinook by area and area grouping for 2025 year to date and the 5-yr average. Bottom: Percentage change in total released catch (2025 YTD versus 5-yr average)."

#r25.1/r25.2

```

```{r 2025 creel survey summary encounters}
# #| label: fig-2025-creel-summary-encounters
# #| echo: false
# #| message: false
# #| warning: false
# #| fig-height: 9
...
# #| fig-cap: ")."
# 
# d25.enc<-d25.long%>%filter(disposition=="encounters")
# 
# enc25.1<-ggplot(d25.enc,aes(x=area2,y=estimate,fill=year))+
#   geom_col(position="dodge")+
#   scale_fill_brewer(palette="Set1")+
#   theme_bw()+
#   facet_grid(.~region,space="free",scale="free",switch="x",labeller = labeller(region = label_wrap_gen(10)))+
...
#   theme(legend.position="bottom")
# 
# d25.enc.pchange<-d25.enc%>%pivot_wider(names_from="year",values_from="estimate")%>%
#   mutate(pchange=(`2025`-`5-yr`)/`5-yr`*100)%>%
#   select(area2,region,disposition,pchange)
# 
# enc25.2<-ggplot(d25.enc.pchange,aes(x=area2,y=pchange))+
#   geom_col(position="dodge")+
#   #scale_fill_brewer(palette="Set1")+
#   theme_bw()+
#   geom_hline(yintercept=0)+
...
```{r 2025 creel survey summary output encounters}
##| label: fig-2025-creel-summary-output-encounters
##| echo: false
##| message: false
##| warning: false
##| fig-height: 9
...
```{r 2025 creel survey summary per SE}
#| label: fig-2025-creel-summary-perSE
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Percent Standard Error for Chinook total effort, kept catch, and released catch estimates for 2025 year to date, by area and area grouping."
...
ggplot(perse2,aes(x=Area,y=perse,fill=factor(use,levels=c("relatively certain","use with caution","high uncertainty"))))+
         geom_col()+theme_bw()+
         facet_grid(disposition~region,space="free",switch="x",scale="free_x",labeller = labeller(region = label_wrap_gen(10)))+
  scale_fill_manual(values=c("#3CBB75FF","#FDE725FF","firebrick"))+
  labs(x="Area",y="Percent or Relative Standard Error",fill="")+
  theme(legend.position = "bottom")

ggsave("outputs/chinook percent standard error 2025 creel survey.png",dpi=600,height=6,width=7)

```

```{r 2025 creel survey summary per SE coho}
#| label: fig-2025-creel-summary-perSEco
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Percent Standard Error for coho total effort, kept catch, and released catch estimates for 2025 year to date, by area and area grouping."
...
ggplot(perse25co,aes(x=Area,y=perse,fill=factor(use,levels=c("relatively certain","use with caution","high uncertainty"))))+
         geom_col()+theme_bw()+
         facet_grid(disposition~region,space="free",switch="x",scale="free_x",labeller = labeller(region = label_wrap_gen(10)))+
  scale_fill_manual(values=c("#3CBB75FF","#FDE725FF","firebrick"))+
  labs(x="Area",y="Percent or Relative Standard Error",fill="")+
...
ggsave("outputs/coho percent standard error 2025 creel survey.png",dpi=600,height=6,width=7)

```

```{r 2025 creel survey summary monthly effort}
#| label: fig-2025-creel-summary-stats
#| echo: false
#| message: false
#| warning: false

raw.bymonth <- read_excel("data/2025_data/catch and release data august 2025 version.xlsx", sheet = "2025 creel survey chinook") %>%
  filter(year == "2025") %>%
...
```{r 2025 creel survey summary monthly effort}
#| label: fig-2025-creel-summary-monthlyeff
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Chinook recreational fishing effort estimates by area and month, 2025"
...
```{r 2025 creel survey summary monthly kept}
#| label: fig-2025-creel-summary-monthlykept
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Chinook kept catches by area and month, 2025"
...
```{r 2025 creel survey summary monthly released}
#| label: fig-2025-creel-summary-monthlyrel
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Chinook released catches by area and month, 2025"
...
raw.bymonth <- read_excel("data/2024_archive/catch and release data sept 2024 version.xlsx", sheet = "2024 all months") %>%
  mutate(encounters=kept+released) %>%
...
<!-- d23<-read_excel("data/2024_archive/catch and release data sept 2024 version.xlsx",sheet="2023 sept creel survey totals") -->
...
<!-- perse23<-read_excel("data/2024_archive/catch and release data sept 2024 version.xlsx",sheet="percent SE 2023 creel summary")%>%mutate(area2=factor(area)) -->
...
<!-- raw.bymonth <- read_excel("data/2024_archive/catch and release data sept 2024 version.xlsx", sheet = "2023 all months") %>% -->
<!--   mutate(encounters=kept+released) %>% -->
<!--   mutate(month = factor(month, levels = c("June", "July", "August", "September"))) %>% -->
<!--   pivot_longer(c(5:8),names_to="disposition",values_to="estimate")%>% -->
<!--   mutate(area=factor(area)) -->
