...
d25<-read_excel("data/2025_data/catch and release data june 2025 version.xlsx",sheet="2025 june creel survey totals")
...
perse25<-read_excel("data/2025_data/catch and release data june 2025 version.xlsx",sheet="percent SE 2025 creel summary")%>%mutate(area2=factor(area))
