...
#| warning: false
#| 
data<-read_excel("data/2025_data/catch and release data july 2025 version.xlsx",sheet="chinook catch and release")

effort<-read_excel("data/2025_data/catch and release data july 2025 version.xlsx",sheet="effort by target species")
```
...
cnplot_25 <- ggplot(d25_25, aes(x = region, y = estimate)) +
  geom_col() +
  theme_bw() +
...
coplot_25 <- ggplot(d25_25_co, aes(x = region, y = estimate)) +
  geom_col() +
  theme_bw() +
  facet_grid(disposition~month) +
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5, hjust=0.5)) +
...
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Total effort, kept catch, and released catch by area and month for 2025 year to date for Chinook (top) and coho (bottom)."
