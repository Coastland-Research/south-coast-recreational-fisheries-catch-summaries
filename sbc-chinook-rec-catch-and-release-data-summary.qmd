...
#| warning: false
#| 
data<-read_excel("data/catch and release data july 2024 version.xlsx",sheet="chinook catch and release")

effort<-read_excel("data/catch and release data july 2024 version.xlsx",sheet="effort by target species")
```
...
d22<-read_excel("data/catch and release data july 2024 version.xlsx",sheet="2024 july creel survey totals")
...
perse<-read_excel("data/catch and release data july 2024 version.xlsx",sheet="percent SE 2024 creel summary")%>%mutate(area2=factor(area))
