...
raw.bymonth %>%
  filter(disposition == "kept" | disposition == "released") %>%
  ggplot(aes(x = area, y = estimate, fill = month)) +
  geom_col() +
  scale_fill_brewer(palette="Set1")+
  theme_bw()+
...
d22<-read_excel("data/catch and release data aug 2024 version.xlsx",sheet="2023 sept creel survey totals")
...
perse<-read_excel("data/catch and release data aug 2024 version.xlsx",sheet="percent SE 2023 creel summary")%>%mutate(area2=factor(area))
