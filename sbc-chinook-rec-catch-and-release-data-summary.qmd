...
#| warning: false
#| 
data<-read_excel("data/2025_data/catch and release data june 2025 version.xlsx",sheet="chinook catch and release")

effort<-read_excel("data/2025_data/catch and release data june 2025 version.xlsx",sheet="effort by target species")
```
...
# chinook
d25<-read_excel("data/2025_data/catch and release data july 2025 version.xlsx",sheet="2025 creel survey chinook")
...
# coho
d25_co <-read_excel("data/2025_data/catch and release data july 2025 version.xlsx",sheet="2025 creel survey coho")
...
# chinook
perse25<-read_excel("data/2025_data/catch and release data july 2025 version.xlsx",sheet="percent SE 2025 chinook")%>% mutate(area2=factor(area))

# coho
perse25<-read_excel("data/2025_data/catch and release data july 2025 version.xlsx",sheet="percent SE 2025 coho")%>% mutate(area2=factor(area))
...
ggplot(d25_25, aes(x = region, y = estimate)) +
  geom_col() +
  theme_bw() +
...
ggplot(d25_25_co, aes(x = region, y = estimate)) +
  geom_col() +
  theme_bw() +
  facet_grid(disposition~month) +
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5, hjust=0.5)) +
...
```{r 2025 creel survey summary output effort}
...
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Top: Total effort by area and area grouping for 2025 year to date and the 5-yr average. Bottom: Percentage change in total effort (2025 YTD versus 5-yr average)."
