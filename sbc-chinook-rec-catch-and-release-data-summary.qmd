...
#| warning: false
#| 
data<-read_excel("data/catch and release data june 2024 version.xlsx",sheet="chinook catch and release")

effort<-read_excel("data/catch and release data june 2024 version.xlsx",sheet="effort by target species")
```
...
```{r 2022 data read and prep}
#| echo: false
#| message: false
#| warning: false

d22<-read_excel("data/catch and release data june 2024 version.xlsx",sheet="2024 june creel survey totals")
...
```{r 2022 per SE data read}
#| echo: false
#| message: false
#| warning: false

perse<-read_excel("data/catch and release data june 2024 version.xlsx",sheet="percent SE 2024 creel summary")%>%mutate(area2=factor(area))
...
# Effort Data Including 2024

-   data from DFO
-   2002-2024 by month by year by PFMA by management (ISBM versus AABM)
...
```{r 2022 creel survey summary}
#| label: fig-2022-creel-survey-summary
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Top: Total encounters of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total encounters (2022 YTD versus 5-yr average)."
...
```{r 2022 creel survey summary output effort}
#| label: fig-2022-creel-survey-summary-output-effort
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Top: Total effort by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total effort (2022 YTD versus 5-yr average)."

e22.1/e22.2

```

```{r 2022 creel survey summary kept}
#| label: fig-2022-creel-summary-kept
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
...
```{r 2022 creel survey summary output kept}
#| label: fig-2022-creel-summary-output-kept
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Top: Total kept catch of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total kept catch (2022 YTD versus 5-yr average)."

c22.1/c22.2

```

```{r 2022 creel survey summary release}
#| label: fig-2022-creel-summary-release
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
...
```{r 2022 creel survey summary output released}
#| label: fig-2022-creel-summary-output-released
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
#| fig-width: 8
#| fig-cap: "Top: Total released catch of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total released catch (2022 YTD versus 5-yr average)."

r22.1/r22.2

```

```{r 2022 creel survey summary encounters}
#| label: fig-2022-creel-summary-encounters
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
...
```{r 2022 creel survey summary output encounters}
#| label: fig-2022-creel-summary-output-encounters
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
...
```{r 2022 creel survey summary per SE}
#| label: fig-2022-creel-summary-perSE
#| echo: false
#| message: false
#| warning: false
#| fig-height: 9
