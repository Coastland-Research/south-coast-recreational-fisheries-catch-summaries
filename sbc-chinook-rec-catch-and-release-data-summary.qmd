...
d22<-read_excel("data/catch and release data aug 2024 version.xlsx",sheet="2024 aug creel survey totals")
...
raw.bymonth <- read_excel("data/catch and release data aug 2024 version.xlsx", sheet = "2024 all months") %>%
...
d23<-read_excel("data/catch and release data aug 2024 version.xlsx",sheet="2023 sept creel survey totals")
...
perse23<-read_excel("data/catch and release data aug 2024 version.xlsx",sheet="percent SE 2023 creel summary")%>%mutate(area2=factor(area))
...
raw.bymonth <- read_excel("data/catch and release data aug 2024 version.xlsx", sheet = "2023 all months") %>%
  mutate(encounters=kept+released) %>%
