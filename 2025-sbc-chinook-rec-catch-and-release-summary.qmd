...
#| warning: false
#| 
data<-read_excel("data/2025_archive/catch and release data september 2025 version.xlsx",sheet="chinook catch and release")

effort<-read_excel("data/2025_archive/catch and release data september 2025 version.xlsx",sheet="effort by target species")
```
...
# chinook
d25<-read_excel("data/2025_archive/catch and release data september 2025 version.xlsx",sheet="2025 creel survey chinook")
...
# coho
d25_co <-read_excel("data/2025_archive/catch and release data september 2025 version.xlsx",sheet="2025 creel survey coho")
...
# chinook
perse25<-read_excel("data/2025_archive/catch and release data september 2025 version.xlsx",sheet="percent SE 2025 chinook")%>% mutate(Area=factor(area))

# coho
perse25co<-read_excel("data/2025_archive/catch and release data september 2025 version.xlsx",sheet="percent SE 2025 coho")%>% mutate(Area=factor(area))
...
raw.bymonth <- read_excel("data/2025_archive/catch and release data september 2025 version.xlsx", sheet = "2025 creel survey chinook") %>%
  filter(year == "2025") %>%
