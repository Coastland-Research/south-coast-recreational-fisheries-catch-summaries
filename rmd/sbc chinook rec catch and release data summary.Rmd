...
* 2022 versus 5-yr recent average are based on the South Coast Assessment Creel Survey Summary Report from September 2022
...
data<-read_excel("data/catch and release data april 2022 version.xlsx",sheet="chinook catch and release")

effort<-read_excel("data/catch and release data april 2022 version.xlsx",sheet="effort by target species")
```


```{r data read new 2022 effort data,  echo=FALSE,message=FALSE,warning=FALSE}
...
```{r 2022 data read and prep,  echo=FALSE,message=FALSE,warning=FALSE}
d22<-read_excel("data/catch and release data april 2022 version.xlsx",sheet="2022 sept creel survey totals")
...
```{r 2022 per SE data read,  echo=FALSE,message=FALSE,warning=FALSE}
perse<-read_excel("data/catch and release data april 2022 version.xlsx",sheet="percent SE 2022 creel summary")%>%mutate(area2=factor(area))
...
```{r total effort all sbc by area by year, echo=FALSE,message=FALSE,warning=FALSE,fig.height=8.5,fig.width=7,fig.cap="Total effort in number of boat trips by area for all SBC areas."}
...
```{r total catch release effort all sbc, echo=FALSE,message=FALSE,warning=FALSE,fig.height=8,fig.width=5,fig.cap="Top: Total encounters (column height) by disposition (kept, released and released sub-legal) Chinook for all SBC areas. Bottom: Total Chinook directed effort by year and month for all SBC areas."}
...
```{r total across disposition by area,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Kept, released and released sub-legal Chinook by area."}
...
```{r effort by area month,echo=FALSE,message=FALSE,warning=FALSE,fig.height=10,fig.width=8,fig.cap="Chinook directed effort by area and month (2014-2020)"}
...
```{r total by disposition stacked by area,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Kept, released and released sub-legal by area. Total column height is encounters."}
...
```{r total encounters by area,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Total encounters by area 2011-2021. Lines fit by LOESS."}
...
```{r total enucounters by area base versus recent simple, echo=FALSE,message=FALSE,warning=FALSE,fig.height=5,fig.width=8,fig.cap="Percent change in encounters between base period (2011-2019) and 2019-2021."}
...
```{r total enucounters by area base versus recent,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Boxplot of total encounters in base period (2011-2018) versus recent years (2019-2021)."}
...
# 2022 Creel Survey Summary

```{r 2022 creel survey summary,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Top: Total encounters of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total encounters (2022 YTD versus 5-yr average)."}
...
d22.effort.pchange<-d22.effort%>%pivot_wider(names_from="year",values_from="estimate")%>%
  mutate(pchange=(`2022`-`5-yr`)/`5-yr`*100)%>%
...
e22.2<-ggplot(d22.effort.pchange,aes(x=area2,y=pchange))+
  ...
  facet_grid(.~region,space="free",scale="free",switch="x",labeller = labeller(region = label_wrap_gen(10)))+
  labs(x="Area",y="Percent Change in Effort (2022 versus 5-yr average)")
```


```{r 2022 creel survey summary output effort,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Top: Total effort by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total effort (2022 YTD versus 5-yr average)."}
...
```{r 2022 creel survey summary kept,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap=")."}
...
c22.2<-ggplot(d22.kept.pchange,aes(x=area2,y=pchange))+
  ...
  geom_hline(yintercept=0)+
  facet_grid(.~region,space="free",scale="free",switch="x",labeller = labeller(region = label_wrap_gen(10)))+
  labs(x="Area",y="Percent Change in Kept Catch\n(2022 versus 5-yr average)")
```


```{r 2022 creel survey summary output kept,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Top: Total kept catch of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total kept catch (2022 YTD versus 5-yr average)."}
...
```{r 2022 creel survey summary release,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap=")."}
...
```{r 2022 creel survey summary output released,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Top: Total released catch of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total released catch (2022 YTD versus 5-yr average)."}
...
```{r 2022 creel survey summary encounters,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap=")."}
...
```{r 2022 creel survey summary output encounters,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Top: Total encounters of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total encounters (2022 YTD versus 5-yr average)."}
enc22.1/enc22.2
```


```{r 2022 creel survey summary per SE, echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=8,fig.cap="Top: Total encounters of Chinook by area and area grouping for 2022 year to date and the 5-yr average. Bottom: Percentage change in total encounters (2022 YTD versus 5-yr average)."}
perse2<-perse%>%
...
ggsave("outputs/chinook percent standard error 2022 creel survey.png",dpi=600,height=6,width=7)
